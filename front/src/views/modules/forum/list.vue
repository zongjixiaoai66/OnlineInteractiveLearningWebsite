...
<template>
    <div class="main-content">
        <el-dialog title="讨论回复详情" :visible.sync="forumReplyDialogVisible">
            <el-dialog
                    width="30%"
            ...
            <div class="demo-input-suffix">
                <span style="width: 20%">讨论标题:</span><el-input v-model="forumTitle" :disabled="true" placeholder="讨论标题" style="width: 80%"></el-input>
            </div>
            <div class="demo-input-suffix">
                <span style="width: 20%">讨论内容:</span><el-input v-model="forumContent" :disabled="true" placeholder="讨论内容" style="width: 80%" type="textarea"></el-input>
            </div>
            <el-table :data="forumData" height="250">
                ...
                <el-table-column property="insertTime" label="讨论时间" width="160"></el-table-column>
                <el-table-column property="caozuo" label="操作" fixed="right">
                    <template slot-scope="scope">
                        <el-button type="info"                          @click="seeForumContent(scope.row.forumContent)">查看讨论详情</el-button>
                        <el-button v-if="isAuth('forum','删除') && role != '学生'" type="danger" @click="deleteForumData(scope.row.id)" >删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <div class="demo-input-suffix">
                <span style="width: 20%">讨论内容:</span>
                <el-input v-model="forumReplyContent" placeholder="讨论内容" style="width:80%" type="textarea"></el-input>
            </div>
        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '讨论标题' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.forumName" placeholder="讨论标题" clearable></el-input>
                     </el-form-item>
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('forum','查看')" type="primary" icon="el-icon-edit" size="mini" @click="openReplyForum(scope.row.id,scope.row.forumName,scope.row.forumContent)">查看讨论回复</el-button>
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            forumReplyDialogVisible : false,//讨论回复模态框
            forumReplyInfoDialogVisible : false,//讨论回复详情模态框
            superIds : "",//讨论id
            forumTitle : "",//讨论标题
            forumContent : "",//讨论内容
            forumReplyContent : "",//讨论回复内容
            forumReplyInfoContent : "",//讨论某个回复详情 全
            forumData : [],//讨论回复数据集合
        ...
        methods: {
            ...
            // 当前讨论相关 end
                _this.forumReplyContent = "";//讨论回复
                _this.forumReplyDialogVisible = true;//讨论回复模态框
                _this.forumReplyInfoDialogVisible = false;//讨论回复详情模态框
            ...
            seeForumContent(forumContent) {
                let _this = this;
                _this.forumReplyInfoContent = forumContent;//讨论某个回复详情 全
                _this.forumReplyInfoDialogVisible = true;//讨论回复详情模态框
            },
            // 删除数据
            deleteForumData(id){
                let _this = this;
