    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="讨论类型" prop="forumTypes">
                    ...
                    <div v-else>
                        <el-form-item class="input" label="讨论类型" prop="forumValue">
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="讨论标题" prop="forumName">
                        <el-input v-model="ruleForm.forumName"
                                  placeholder="讨论标题" clearable  :readonly="ro.forumName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="讨论标题" prop="forumName">
                            <el-input v-model="ruleForm.forumName"
                                      placeholder="讨论标题" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   forumStateTypes: [
                              { required: true, message: '讨论状态不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
