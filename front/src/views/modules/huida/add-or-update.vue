    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='zuoye' ">
                    <el-form-item class="input" v-if="type!='info'"  label="班级类型" prop="banjiValue">
                        <el-input v-model="zuoyeForm.banjiValue"
                                  placeholder="班级类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
    ...
    export default {
        ...
        created() {
         ...
         this.$http({
            ...
            if(this.$route.query.zuoyeId != null && this.$route.query.zuoyeId != ""){
                this.ruleForm.zuoyeId = this.$route.query.zuoyeId;
                this.zuoyeChange(this.$route.query.zuoyeId);
            }
        },
        mounted() {
        },
