    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        if(StringUtil.isEmpty(role))
            ...
            YonghuEntity yonghu = yonghuService.selectById(String.valueOf(request.getSession().getAttribute("userId")));
            params.put("banjiTypes",yonghu.getBanjiTypes());
...
//                            zuoyeEntity.setBanjiTypes(Integer.valueOf(data.get(0)));   //班级类型 要改的
